# 07/29/25, TJ
# Proofread first, not deployable
...
#' Outputs are read in for extraction in the `spp_occ_background.Rmd` as well as generating 
#' suitability prediction maps in the `kern_sdm.Rmd` markdown.
...
filepath = here('data/bcm/bcmv8_historic/2000_2023_monthly//')
...
pathIn = here("data/bcm/bcmv8_historic/2000_2023_monthly//")
...
writeRaster(pptStack_avg,
            here("data/bcm/bcmv8_historic/monthly_avgs/ppt_winter_avg.tif"), overwrite=TRUE)


## Avg of summer tmx --------------------------------------------------------
tmxFiles <- list.files(
  path = "/home/tjsipin/madi/SDMplants/data/bcm/bcmv8_historic/quarterly_avgs//",
...
tmxStack_avg <- terra::app(tmxStack, fun = "mean") ###error in code. Nick read in pptStack rather than tmxStack, fixed 10/8/25
writeRaster(tmxStack_avg,
            "data/bcm/bcmv8_historic/monthly_avgs/tmx_summer_avg.tif", overwrite=TRUE)
...
# polaris_silt <- rast(here("data/polaris/rasters/polaris_silt_0200_270m_lowFilter.tif"))
# polaris_ph <- rast(here("data/polaris/rasters/polaris_ph_0200_270m_lowFilter.tif"))
# polaris_om <- rast(here("data/polaris/rasters/polaris_om_0200_270m_lowFilter.tif"))
# polaris_sand <- rast(here("data/polaris/rasters/polaris_sand_0200_270m_lowFilter.tif"))
# polaris_clay <-rast(here("data/polaris/rasters/polaris_clay_0200_270m_lowFilter.tif"))
# polaris_bd <-rast(here("data/polaris/rasters/polaris_bd_0200_270m_lowFilter.tif"))
# 
# #Read in sample BCM raster to match extent and resolution
# bcm_r <- rast(here("data/bcm/bcmv8_historic/monthly_avgs/tmx_jan_avg.tif"))
# 
...
#               here(paste0("data/polaris/rasters/updated_", var_name, "_270m_lowFilter.tif")), 
#               overwrite = TRUE)
# }
# 
