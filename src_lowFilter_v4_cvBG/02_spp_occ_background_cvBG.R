...
# source('src_lowFilter_v4_cvBG/util/generate_backOcc.R')
# dir.create('data_v4_cvBG/2_background', recursive=T)
...
# 
#         ## Save
#         write_csv(backOcc_pts, paste0("data_v4_cvBG/2_background/back_",
#                                       names[i],
#                                       "_5km_lowFilter.csv"))
#     }
# )
...
# source("src_lowFilter_v4_cvBG/util/generateMonths_backOcc_matchMonth.R")
# #Use this for agg and comprehensive monthly model
# source("src_lowFilter_v4_cvBG/util/generateMonths_backOcc_evenMonth.R")
# 
# 
...
#         set.seed(123)
#         print(i)
#         matching_backOcc_pts.filename = paste0("data_v4_cvBG/2_background/back_", names[i], "_5km_lowFilter_match.csv")
#         matching_backOcc_pts = generateMatchingMonths(sp = names[i])
#         write_csv(matching_backOcc_pts, matching_backOcc_pts.filename)
#         
#         even_backOcc_pts.filename = paste0("data_v4_cvBG/2_background/back_", names[i], "_5km_lowFilter_even.csv")
...
dir.create('data_v4_cvBG/3_swd/monthly/selective', recursive=T)
source('src_lowFilter_v4_cvBG/util/env_extract_monthly.R')
...
#         out.filename = paste0('data_v4_cvBG/3_swd/monthly/selective/swd_', spp, '_', occ_back, '_soil200cm_lowFilter_monthly_selective.csv')
#         
#         if(file.exists(out.filename)) return(NULL)
#         if(occ_back=='occ'){
#             points.filename = paste0('data/1_occ/combined_spp_occ/', spp, '_lowFilter.csv')
#         } else{
#             points.filename = paste0("data_v4_cvBG/2_background/back_", spp, "_5km_lowFilter_match.csv")
#         }
...
#     function(sp){
#         print(sp)
#         out.dir = paste0('data_v4_cvBG/3_swd/monthly/selective')
...
# dir.create('data_v4_cvBG/3_swd/monthly/comprehensive', recursive=T)
# set.seed(123)
# map(
#     1:nrow(spp_occ_back),
#     function(i){
#         spp = spp_occ_back$spp[i]
#         occ_back = spp_occ_back$occ_back[i]
#         out.filename = paste0('data_v4_cvBG/3_swd/monthly/comprehensive/swd_', spp, '_', occ_back, '_soil200cm_lowFilter_monthly_comprehensive.csv')
#         # if(file.exists(out.filename)) return(NULL)
#         if(occ_back=='occ'){
#             points.filename = paste0('data/1_occ/combined_spp_occ/', spp, '_lowFilter.csv')
#         } else{
#             points.filename = paste0("data_v4_cvBG/2_background/back_", spp, "_5km_lowFilter_even.csv")
#         }
#         points = read_csv(points.filename)
#         
#         print(spp)
...
#     function(sp){
#         print(sp)
#         out.dir = paste0('data_v4_cvBG/3_swd/monthly/comprehensive')
#         #Get occ and back extracted sets
...
dir.create('data_v4_cvBG/3_swd/wy', recursive=T)
...
map(
    names,
    function(sp){
        out.dir = paste0('data_v4_cvBG/3_swd/wy')
        #Get occ and back extracted sets
...
# ####Agg####
# ## Read in fxn
# source('src_lowFilter_v4_cvBG/util/env_extract_agg.R')
# dir.create('data_v4_cvBG/3_swd/agg', recursive=T)
...
#     names,
#     function(sp){
#         out.dir = paste0('data_v4_cvBG/3_swd/agg')
#         #Get occ and back extracted sets
...
#         lowBack.filename = paste0('data_v4_cvBG/2_background/back_', sp, '_5km_lowFilter.csv')
#         highOcc.filename = paste0('data/1_occ/combined_spp_occ/', sp, '_highFilter.csv')
#         highBack.filename = paste0('data_v4_cvBG/2_background/back_', sp, '_5km_highFilter.csv')
#         swd.lowOcc.filename = paste0('data_v4_cvBG/3_swd/agg/', '/swd_', sp, '_occ_soil200cm_lowFilter_agg.csv')
#         swd.lowBack.filename = paste0('data_v4_cvBG/3_swd/agg/', '/swd_', sp, '_back_soil200cm_lowFilter_agg.csv')
#         swd.highOcc.filename = paste0('data_v4_cvBG/3_swd/agg/', '/swd_', sp, '_occ_soil200cm_highFilter_agg.csv')
#         swd.highBack.filename = paste0('data_v4_cvBG/3_swd/agg/', '/swd_', sp, '_back_soil200cm_highFilter_agg.csv')
#
...
# #         highOcc.filename = paste0('data/1_occ/combined_spp_occ/', sp, '_highFilter.csv')
# #         highBack.filename = paste0('data_v4_cvBG/2_background/back_', sp, '_5km_highFilter.csv')
# #         swd.lowOcc.filename = paste0('data_v4_cvBG/3_swd/monthly/comprehensive//', '/swd_', sp, '_occ_soil200cm_lowFilter_monthly_comprehensive.csv')
# #         swd.lowBack.filename = paste0('data_v4_cvBG/3_swd/monthly/comprehensive//', '/swd_', sp, '_back_soil200cm_lowFilter_monthly_comprehensive.csv')
# #         swd.highOcc.filename = paste0('data_v4_cvBG/3_swd/monthly/comprehensive//', '/swd_', sp, '_occ_soil200cm_highFilter_monthly_comprehensive.csv')
# #         swd.highBack.filename = paste0('data_v4_cvBG/3_swd/monthly/comprehensive//', '/swd_', sp, '_back_soil200cm_highFilter_monthly_comprehensive.csv')
# #
# #         lowOcc = read_csv(lowOcc.filename)
# #         lowBack = read_csv(lowBack.filename)
# #         highOcc = read_csv(highOcc.filename)
...
# #         highOcc.filename = paste0('data/1_occ/combined_spp_occ/', sp, '_highFilter.csv')
# #         highBack.filename = paste0('data_v4_cvBG/2_background/back_', sp, '_5km_highFilter.csv')
# #         swd.lowOcc.filename = paste0('data_v4_cvBG/3_swd/monthly/selective//', '/swd_', sp, '_occ_soil200cm_lowFilter_monthly_selective.csv')
# #         swd.lowBack.filename = paste0('data_v4_cvBG/3_swd/monthly/selective//', '/swd_', sp, '_back_soil200cm_lowFilter_monthly_selective.csv')
# #         swd.highOcc.filename = paste0('data_v4_cvBG/3_swd/monthly/selective//', '/swd_', sp, '_occ_soil200cm_highFilter_monthly_selective.csv')
# #         swd.highBack.filename = paste0('data_v4_cvBG/3_swd/monthly/selective//', '/swd_', sp, '_back_soil200cm_highFilter_monthly_selective.csv')
# #
# #         lowOcc = read_csv(lowOcc.filename)
# #         lowBack = read_csv(lowBack.filename)
# #         highOcc = read_csv(highOcc.filename)
