...
dir.create('data_cvBG/5_figs/lowFilter/wy', recursive=T)
...
#Extract legend
sp='l_gracilis'
input.legend.filename = paste0("data_cvBG/4_maxent_outputs/wy/", sp, "/lowFilter/monthly_dist_hist/", sp, "_2000_2023_wy.tif")
...
ggsave('data_cvBG/5_figs/lowFilter/wy/fig2.png', width = 2800, height = 2180, units = "px", bg = 'white')
...
species <- names
wy_root <- "data_cvBG/4_maxent_outputs/wy"
...
ggsave(
    'data_cvBG/5_figs/lowFilter/wy/fig3_RCP45.png', 
    plot = p_45_final,
...
ggsave(
    'data_cvBG/5_figs/lowFilter/wy/fig3_RCP85.png', 
    plot = p_85_final,
...
p10Panel <- function(model, show_compass = FALSE) {
    ...
    base_dir = 'data_cvBG/4_maxent_outputs/wy/p10/'
...
final_path <- paste0('data_cvBG/5_figs/lowFilter/wy/fig4.png')
...
suitable_hectares_CA = map(
    ...
    function(sp){
        print(sp)
        input.filename.hist = paste0('data_cvBG/4_maxent_outputs/wy/', sp, '/lowFilter/p10/', '/p10_', sp, '_2000_2023_wy.tif')
        input.filename.RCP45 = paste0('data_cvBG/4_maxent_outputs/wy/', sp, '/lowFilter/p10/', '/p10_', sp, '_MIROC45_2070_2099_wy.tif')
        input.filename.RCP85 = paste0('data_cvBG/4_maxent_outputs/wy/', sp, '/lowFilter/p10/', '/p10_', sp, '_MIROC85_2070_2099_wy.tif')
...
dir.create('data_cvBG/6_tables/lowFilter/wy', recursive=T)
write_csv(suitable_hectares_CA, "data_cvBG/6_tables/lowFilter/wy/suitable_hectares_wy_CA.csv")
suitable_hectares_CA = read_csv("data_cvBG/6_tables/lowFilter/wy/suitable_hectares_wy_CA.csv")
...
dir.create('data_cvBG/6_tables/lowFilter/wy')
write_csv(suitable_hectares_CV, "data_cvBG/6_tables/lowFilter/wy/suitable_hectares_wy_CV.csv")
...
write_csv(aucs, 'data_cvBG/6_tables/lowFilter/wy/aucs_lowFilter.csv')


# Permutation importance --------------------------------------------------

getVImp = function(sp){
    mod.filename = paste0('data_cvBG/4_maxent_outputs/wy/', sp, '/lowFilter/model/', sp, '_final_sdm.rds')
    sp_pretty = sp %>% 
        str_replace("_", ". ") %>% 
        str_to_sentence()
...
var_imps = map(
    ...
    bind_rows()
write_csv(var_imps, 'data_cvBG/6_tables/lowFilter/wy/perm_var_imps_lowFilter.csv')
...
current_p10_rasts = map(
    ...
    function(sp){
        list.files(
            paste0('data_cvBG/4_maxent_outputs/wy/', sp, '/lowFilter/p10/'),
...
ggsave("data_cvBG/5_figs/lowFilter/wy/figS4.png", width = 2040, height = 1440, units='px', scale = 2)
...
write_csv(suitable_sp_count.all_wider, "data_cvBG/6_tables/lowFilter/wy/tableS9_nsp_ha.csv")