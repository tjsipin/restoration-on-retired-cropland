...
fig5_data = map(
    ...
    function(sp){
        in.filename = paste0('data_v5_50km/6_tables/lowFilter/comprehensive/ha_histograms/p10_', sp, '_suitable_ha_CV.csv')
        in.file=read_csv(in.filename)
...
ggsave('data_v5_50km/5_figs/lowFilter/fig5.png', scale = 2, width = 7, height = 4, units = 'in', bg = 'white')
...
ggsave('data_v5_50km/5_figs/lowFilter/comprehensive/figS6_varImp.png', width = 3200, height = 2400, units = 'px', bg='white')
