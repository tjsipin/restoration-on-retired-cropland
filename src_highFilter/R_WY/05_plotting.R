...
dir.create('data_v5_50km_highFilter/5_figs/highFilter/wy', recursive=T)
...
distributionSpPlotWithoutLegend = function(sp){
    print(sp)
    output.filename = paste0("data_v5_50km_highFilter/5_figs/highFilter/wy/fig2_", sp, "_2000_2023.png")
    input.filename = paste0("data_v5_50km_highFilter/4_maxent_outputs/wy/", sp, "/highFilter/monthly_dist_hist/", sp, "_2000_2023_wy.tif")
...
#Extract legend
sp='c_lasiophyllus'
input.legend.filename = paste0("data_v5_50km_highFilter/4_maxent_outputs/wy/", sp, "/highFilter/monthly_dist_hist/", sp, "_2000_2023_wy.tif")
...
ggsave('data_v5_50km_highFilter/5_figs/highFilter/wy/fig2.png', width = 2800, height = 2180, units = "px", bg = 'white')
...
#'     p10_dir  <- file.path(wy_root, spp, "highFilter", "p10")
...
#' )
#' ggsave(
#'     'data_v5_50km/5_figs/highFilter/wy/fig3_RCP45.png', 
#'     plot = p_45_final,
...
#' )
#' ggsave(
#'     'data_v5_50km/5_figs/highFilter/wy/fig3_RCP85.png', 
#'     plot = p_85_final,
...
#'     input_rast_CA_name <- paste0(base_dir, model, "_highFilter_sum_CA.tif")
#'     input_rast_CV_name <- paste0(base_dir, model, "_highFilter_sum_CV.tif")
#'     
...
#'     base_dir = 'data_v5_50km/4_maxent_outputs/wy/p10/'
#'     input_rast_CV_name <- paste0(base_dir, model_for_scale, "_highFilter_sum_CV.tif")
#'     input_rast_CV = rast(input_rast_CV_name)
#'     names(input_rast_CV) <- "sum"
#'     input_rast_CV <- input_rast_CV %>% 
#'         mutate(sum = factor(sum, levels = 0:10))
...
#' final_path <- paste0('data_v5_50km/5_figs/highFilter/wy/fig4.png')
...
#'     function(sp){
#'         print(sp)
#'         input.filename.hist = paste0('data_v5_50km/4_maxent_outputs/wy/', sp, '/highFilter/p10/', '/p10_', sp, '_2000_2023_wy.tif')
#'         input.filename.RCP45 = paste0('data_v5_50km/4_maxent_outputs/wy/', sp, '/highFilter/p10/', '/p10_', sp, '_MIROC45_2070_2099_wy.tif')
#'         input.filename.RCP85 = paste0('data_v5_50km/4_maxent_outputs/wy/', sp, '/highFilter/p10/', '/p10_', sp, '_MIROC85_2070_2099_wy.tif')
#'         
#'         
#'         
...
#'     bind_rows() 
#' 
#' dir.create('data_v5_50km/6_tables/highFilter/wy', recursive=T)
#' write_csv(suitable_hectares_CA, "data_v5_50km/6_tables/highFilter/wy/suitable_hectares_wy_CA.csv")
#' suitable_hectares_CA = read_csv("data_v5_50km/6_tables/highFilter/wy/suitable_hectares_wy_CA.csv")
#' 
#' ref_rast = rast('data/0_env/bcm/bcmv8_historic/2000_2023_monthly/aet1999dec.tif')
#' cv_rast = ref_rast %>% 
#'     crop(central_valley, mask = T) 
...
#'     bind_rows() 
#' 
#' dir.create('data_v5_50km/6_tables/highFilter/wy')
#' write_csv(suitable_hectares_CV, "data_v5_50km/6_tables/highFilter/wy/suitable_hectares_wy_CV.csv")
#' 
#' # AUCs table --------------------------------------------------------------
#' 
#' aucs = map(
#'     1:7,
#'     function(i){
#'         training = read_csv(paste0('data_v5_50km/3_swd/wy/training_', names[i], '_soil200cm_highFilter_agg.csv'))
#'         testing = read_csv(paste0('data_v5_50km/3_swd/wy/testing_', names[i], '_soil200cm_highFilter_agg.csv'))
#'         model = readRDS(paste0('data_v5_50km/4_maxent_outputs/wy/', names[i], '/highFilter/model_training/', names[i], '_training_sdm.rds'))
#'         best_rm = readRDS(paste0('data_v5_50km/4_maxent_outputs/wy/tuning/', names[i], '_finalModelArgs_highFilter.rds'))[4] %>%
#'             str_split_i('=', 2)
#'         
...
#'     bind_rows()
#' 
#' write_csv(aucs, 'data_v5_50km/6_tables/highFilter/wy/aucs_highFilter.csv')
#' 
#' 
#' # Permutation importance --------------------------------------------------
#' 
#' getVImp = function(sp){
#'     mod.filename = paste0('data_v5_50km/4_maxent_outputs/wy/', sp, '/highFilter/model/', sp, '_final_sdm.rds')
#'     sp_pretty = sp %>% 
#'         str_replace("_", ". ") %>% 
#'         str_to_sentence()
...
#' ) %>% 
#'     bind_rows()
#' write_csv(var_imps, 'data_v5_50km/6_tables/highFilter/wy/perm_var_imps_highFilter.csv')
#' 
#' sp_pretty_c = names %>% 
#'     str_replace('_', '. ') %>% 
#'     str_to_sentence()
...
#'     function(sp){
#'         list.files(
#'             paste0('data_v5_50km/4_maxent_outputs/wy/', sp, '/highFilter/p10/'),
...
#'         )
#'     )
#' ggsave("data_v5_50km/5_figs/highFilter/wy/figS5.png", width = 2040, height = 1440, units='px', scale = 2)
...
#' write_csv(suitable_sp_count.all_wider, "data_v5_50km/6_tables/highFilter/wy/tableS9_nsp_ha.csv")
#' 
#' 
#' p10_rasts = map(
#'     names,
#'     function(sp=.x){
#'         file=paste0('data_v5_50km/4_maxent_outputs/wy/', sp, '/highFilter/p10/p10_', sp, '_2000_2023_wy.tif')
#'         r = rast(file) %>% 
#'             crop(cv_rast, mask=T) %>% 
...
#' ggsave('data_v5_50km/5_figs/highFilter/wy/figS2_p10_facet.png', width=3200, height=2800, units='px', bg='white')
#' 
#' p10_sums = paste0('data_v5_50km/4_maxent_outputs/wy/p10/2000_2023_highFilter_sum_CV.tif') %>% 
#'     rast()
#' 
#' p10_sums_r = p10_sums %>% 
#'     mutate(
...
#'     select(bins) 
#' 
#' p10_sums_r_RCP45 = rast('data_v5_50km/4_maxent_outputs/wy/p10/MIROC45_2070_2099_highFilter_sum_CV.tif') %>% 
#'     mutate(
#'         bins=case_when(
#'             sum == 0 ~ '0',
#'             sum == 1 ~ '1',
...
#'     ) %>%
#'     select(bins) 
#' p10_sums_r_RCP85 = rast('data_v5_50km/4_maxent_outputs/wy/p10/MIROC85_2070_2099_highFilter_sum_CV.tif') %>% 
#'     mutate(
#'         bins=case_when(
#'             sum == 0 ~ '0',
#'             sum == 1 ~ '1',
...
#'     function(sp){
#'         fi = paste0(
#'             'data/1_occ/combined_spp_occ/', sp, '_highFilter.csv'
#'         )
#'         dat = read_csv(fi) %>% 
#'             mutate(sp = sp) %>% 
#'             select(lat, lon, sp)
...
#'         strip.clip = 'off'
#'     ) 
#' ggsave('data/5_figs/figS7.png', width=3200, height=2400, units='px', bg='white')
#' 
#' 
#' 
#' # Appendix ----------------------------------------------------------------
#' # suitable_hectares_CV = read_csv("data_v5_50km/6_tables/highFilter/wy/suitable_hectares_agg_CV.csv")
...
#' #     ) %>% 
#' #     kable_classic(html_font = 'Times') %>% 
#' #     save_kable('data_v5_50km/6_tables/highFilter/wy/suitable_hectares_agg_CA.png')
#' # 
#' # 
...
#' #     ) %>% 
#' #     kable_classic(html_font = 'Times') %>% 
#' #     save_kable('data_v5_50km/6_tables/highFilter/wy/suitable_hectares_agg_CV.png')
#' # 
#' # 
...
#' #         tmx.filename = paste0('data_v5_50km/4_maxent_outputs/wy/', sp, '/highFilter/model/plots/species_tmx.dat')
...
#' #         str_to_lower()
#' # 
#' #     output.filename = paste0('data_v5_50km/5_figs/highFilter/wy/tmx_opt_diff_', sp, '_', model, '_highFilter.png')
#' # 
#' #     if(model == "hist"){
...
#' #         }
#' #     )
#' #     output.filename = paste0('data_v5_50km/5_figs/highFilter/wy/env_diff/diff_future_', future, '_highFilter.png')
...
#' #     output.filename = paste0(output.filepath, sp, '_envDistribution_highFilter.png')
#' #     training = read_csv(paste0('data_v5_50km/3_swd/wy/training_', sp, '_soil200cm_highFilter_agg.csv')) %>% 
#' #         mutate(
#' #             tdiff = tmx - tmn,
